import { r as reactExports, U as jsxRuntimeExports, a1 as React } from "./worker-entry-BftUDJXA.js";
...
function KitiMascot({ size = 240, animate = true, className = "", type = "hero" }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `relative flex items-center justify-center ${className}`, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Wrapper, { ...wrapperProps, className: "relative z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.img,
      {
        src: typeImages[type],
    ...
    animate && type === "analyzing" && /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: [...Array(3)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
...
function GlassCard({
  ...
  const variantClass = variant === "strong" ? "glass-strong" : variant === "soft" ? "bg-card/80" : "glass";
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      whileHover: hover2 ? { y: -4, transition: { type: "spring", stiffness: 300 } } : void 0,
      className: cn(
        variantClass,
        "rounded-[2rem] p-7 md:p-8 shadow-card border border-white/50 transition-all duration-300",
        hover2 && "hover:shadow-hover hover:border-white/80 cursor-pointer",
        className
      ),
      ...props,
      children
...
const mockAudit = {
  ...
  painPoints: [
    { text: "12% of reviews mention warping after dishwasher use", severity: "high" },
    { text: "Customers expect oil included — not in package", severity: "medium" },
    { text: "Smallest board feels too thin per 8% of reviewers", severity: "medium" }
  ],
  whatsWorking: [
  ...
  fixes: [
    { priority: "high", title: "Add 'hand-wash only' to bullet #1 and main image overlay", impact: "+8 score" },
    { priority: "high", title: "Bundle a small bottle of mineral oil — match top competitor", impact: "+6 score" },
    { priority: "medium", title: "Rewrite bullet #3 to lead with thickness specs", impact: "+4 score" },
    { priority: "low", title: "Add lifestyle image with cheese & charcuterie board context", impact: "+2 score" }
  ]
};
