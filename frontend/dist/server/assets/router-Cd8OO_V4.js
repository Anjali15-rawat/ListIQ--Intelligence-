...
const appCss = "/assets/styles-DCAetdOK.css";
...
const Route$2 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "twitter:site", content: "@ListIQ" }
    ],
    links: [
      {
        rel: "preconnect",
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;600;700;800&family=Syne:wght@700;800&display=swap"
      },
...
const $$splitComponentImporter$1 = () => import("./dashboard-BHi5iatf.js");
const Route$1 = createFileRoute("/dashboard")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Your Amazon listing intelligence dashboard."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-BVw8TnqP.js");
